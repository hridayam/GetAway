  ...
  render() {
    return (
        <Container className = "suggestion" >
            ...
            <Row >
                <Col className="suggestion-card wow slideInLeft" sm="12" lg="4">
                ...
                <Col className="suggestion-card" sm="12" lg="4">
                    <Card style={{height: '30rem'}}>
                        <View zoom>
                ...
                <Col className="suggestion-card wow slideInRight" sm="12" lg="4" >
                     <Card style={{height: '30rem'}}>
                        <View zoom>
